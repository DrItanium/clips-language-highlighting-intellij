...
public class CLIPSForallCEImpl extends ASTWrapperPsiElement implements CLIPSForallCE {

  public CLIPSForallCEImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitForallCE(this);
  }
