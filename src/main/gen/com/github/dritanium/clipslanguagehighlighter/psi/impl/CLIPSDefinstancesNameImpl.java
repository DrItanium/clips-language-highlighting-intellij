...
public class CLIPSDefinstancesNameImpl extends ASTWrapperPsiElement implements CLIPSDefinstancesName {

  public CLIPSDefinstancesNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitDefinstancesName(this);
  }
