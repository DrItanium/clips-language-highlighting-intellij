...
public class CLIPSExistsCEImpl extends ASTWrapperPsiElement implements CLIPSExistsCE {

  public CLIPSExistsCEImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitExistsCE(this);
  }
