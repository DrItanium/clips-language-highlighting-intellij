...
public class CLIPSDefaultAttributeImpl extends ASTWrapperPsiElement implements CLIPSDefaultAttribute {

  public CLIPSDefaultAttributeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitDefaultAttribute(this);
  }
