...
public class CLIPSPropagationFacetImpl extends ASTWrapperPsiElement implements CLIPSPropagationFacet {

  public CLIPSPropagationFacetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitPropagationFacet(this);
  }
