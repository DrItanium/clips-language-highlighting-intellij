...
public class CLIPSCreateAccessorFacetImpl extends ASTWrapperPsiElement implements CLIPSCreateAccessorFacet {

  public CLIPSCreateAccessorFacetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitCreateAccessorFacet(this);
  }
