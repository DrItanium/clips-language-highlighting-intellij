...
public class CLIPSMultifieldVariableImpl extends ASTWrapperPsiElement implements CLIPSMultifieldVariable {

  public CLIPSMultifieldVariableImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitMultifieldVariable(this);
  }
