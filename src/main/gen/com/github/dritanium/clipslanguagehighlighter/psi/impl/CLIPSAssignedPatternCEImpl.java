...
public class CLIPSAssignedPatternCEImpl extends ASTWrapperPsiElement implements CLIPSAssignedPatternCE {

  public CLIPSAssignedPatternCEImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitAssignedPatternCE(this);
  }
  ...
  public CLIPSPatternCE getPatternCE() {
    return findNotNullChildByClass(CLIPSPatternCE.class);
  }
