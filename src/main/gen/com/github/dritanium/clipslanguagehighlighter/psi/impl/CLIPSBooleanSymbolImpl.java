...
public class CLIPSBooleanSymbolImpl extends ASTWrapperPsiElement implements CLIPSBooleanSymbol {

  public CLIPSBooleanSymbolImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitBooleanSymbol(this);
  }
