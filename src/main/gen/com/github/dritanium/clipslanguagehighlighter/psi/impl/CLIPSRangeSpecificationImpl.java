...
public class CLIPSRangeSpecificationImpl extends ASTWrapperPsiElement implements CLIPSRangeSpecification {

  public CLIPSRangeSpecificationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitRangeSpecification(this);
  }
  ...
  @Override
  @Nullable
  public CLIPSNumber getNumber() {
    return findChildByClass(CLIPSNumber.class);
  }
