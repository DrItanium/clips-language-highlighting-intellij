...
public class CLIPSDefglobalConstructImpl extends ASTWrapperPsiElement implements CLIPSDefglobalConstruct {
  ...
  @Override
  @Nullable
  public CLIPSDefmoduleName getDefmoduleName() {
    return findChildByClass(CLIPSDefmoduleName.class);
  }

  @Override
  @NotNull
  public List<CLIPSGlobalAssignment> getGlobalAssignmentList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CLIPSGlobalAssignment.class);
  }
