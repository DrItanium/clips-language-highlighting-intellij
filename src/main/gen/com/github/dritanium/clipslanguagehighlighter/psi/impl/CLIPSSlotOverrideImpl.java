...
public class CLIPSSlotOverrideImpl extends ASTWrapperPsiElement implements CLIPSSlotOverride {

  public CLIPSSlotOverrideImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitSlotOverride(this);
  }
  ...
  @Override
  @NotNull
  public CLIPSSlotNameExpression getSlotNameExpression() {
    return findNotNullChildByClass(CLIPSSlotNameExpression.class);
  }
