...
public class CLIPSFloatListImpl extends ASTWrapperPsiElement implements CLIPSFloatList {

  public CLIPSFloatListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitFloatList(this);
  }
