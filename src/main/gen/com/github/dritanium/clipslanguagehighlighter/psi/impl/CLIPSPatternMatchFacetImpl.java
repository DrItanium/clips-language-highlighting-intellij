...
public class CLIPSPatternMatchFacetImpl extends ASTWrapperPsiElement implements CLIPSPatternMatchFacet {

  public CLIPSPatternMatchFacetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitPatternMatchFacet(this);
  }
