...
public class CLIPSSlotImpl extends ASTWrapperPsiElement implements CLIPSSlot {

  public CLIPSSlotImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<CLIPSFacet> getFacetList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CLIPSFacet.class);
  }
