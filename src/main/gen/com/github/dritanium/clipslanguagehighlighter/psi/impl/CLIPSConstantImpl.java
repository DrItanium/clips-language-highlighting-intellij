...
public class CLIPSConstantImpl extends ASTWrapperPsiElement implements CLIPSConstant {

  public CLIPSConstantImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public CLIPSInstanceName getInstanceName() {
    return findChildByClass(CLIPSInstanceName.class);
  }
