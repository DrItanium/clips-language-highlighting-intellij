...
public class CLIPSCardinalitySpecificationImpl extends ASTWrapperPsiElement implements CLIPSCardinalitySpecification {

  public CLIPSCardinalitySpecificationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitCardinalitySpecification(this);
  }
