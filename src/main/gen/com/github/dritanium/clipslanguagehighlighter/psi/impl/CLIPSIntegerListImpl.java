...
public class CLIPSIntegerListImpl extends ASTWrapperPsiElement implements CLIPSIntegerList {

  public CLIPSIntegerListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitIntegerList(this);
  }
