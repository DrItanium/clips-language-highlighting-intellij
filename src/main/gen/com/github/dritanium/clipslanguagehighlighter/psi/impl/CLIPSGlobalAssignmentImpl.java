...
public class CLIPSGlobalAssignmentImpl extends ASTWrapperPsiElement implements CLIPSGlobalAssignment {

  public CLIPSGlobalAssignmentImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public CLIPSExpression getExpression() {
    return findNotNullChildByClass(CLIPSExpression.class);
  }

  @Override
  @NotNull
  public CLIPSGlobalVariable getGlobalVariable() {
    return findNotNullChildByClass(CLIPSGlobalVariable.class);
  }
