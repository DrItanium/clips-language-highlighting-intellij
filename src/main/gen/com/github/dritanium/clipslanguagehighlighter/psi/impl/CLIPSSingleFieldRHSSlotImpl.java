...
public class CLIPSSingleFieldRHSSlotImpl extends ASTWrapperPsiElement implements CLIPSSingleFieldRHSSlot {

  public CLIPSSingleFieldRHSSlotImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitSingleFieldRHSSlot(this);
  }
  ...
  @Override
  @NotNull
  public CLIPSRHSField getRHSField() {
    return findNotNullChildByClass(CLIPSRHSField.class);
  }
