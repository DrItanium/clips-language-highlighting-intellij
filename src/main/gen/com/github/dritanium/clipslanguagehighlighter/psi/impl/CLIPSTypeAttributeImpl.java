...
public class CLIPSTypeAttributeImpl extends ASTWrapperPsiElement implements CLIPSTypeAttribute {

  public CLIPSTypeAttributeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitTypeAttribute(this);
  }
  ...
  @Override
  @NotNull
  public CLIPSTypeSpecification getTypeSpecification() {
    return findNotNullChildByClass(CLIPSTypeSpecification.class);
  }
