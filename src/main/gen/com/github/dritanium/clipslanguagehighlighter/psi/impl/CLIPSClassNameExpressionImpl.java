...
public class CLIPSClassNameExpressionImpl extends ASTWrapperPsiElement implements CLIPSClassNameExpression {

  public CLIPSClassNameExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitClassNameExpression(this);
  }
