...
public class CLIPSPatternMatchRoleImpl extends ASTWrapperPsiElement implements CLIPSPatternMatchRole {

  public CLIPSPatternMatchRoleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitPatternMatchRole(this);
  }
