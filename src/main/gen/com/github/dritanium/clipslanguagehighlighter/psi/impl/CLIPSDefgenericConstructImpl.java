...
public class CLIPSDefgenericConstructImpl extends ASTWrapperPsiElement implements CLIPSDefgenericConstruct {

  public CLIPSDefgenericConstructImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitDefgenericConstruct(this);
  }
