...
public class CLIPSConstructNameImpl extends ASTWrapperPsiElement implements CLIPSConstructName {

  public CLIPSConstructNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitConstructName(this);
  }
