...
public class CLIPSWildcardParameterImpl extends ASTWrapperPsiElement implements CLIPSWildcardParameter {

  public CLIPSWildcardParameterImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitWildcardParameter(this);
  }
