...
public class CLIPSMultifieldRHSSlotImpl extends ASTWrapperPsiElement implements CLIPSMultifieldRHSSlot {

  public CLIPSMultifieldRHSSlotImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitMultifieldRHSSlot(this);
  }
