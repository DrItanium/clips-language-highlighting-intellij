...
public class CLIPSSingleFieldLHSSlotImpl extends ASTWrapperPsiElement implements CLIPSSingleFieldLHSSlot {

  public CLIPSSingleFieldLHSSlotImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitSingleFieldLHSSlot(this);
  }
  ...
  @Override
  @NotNull
  public CLIPSConstraint getConstraint() {
    return findNotNullChildByClass(CLIPSConstraint.class);
  }
