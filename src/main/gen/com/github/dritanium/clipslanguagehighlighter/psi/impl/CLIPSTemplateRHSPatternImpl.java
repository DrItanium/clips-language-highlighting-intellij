...
public class CLIPSTemplateRHSPatternImpl extends ASTWrapperPsiElement implements CLIPSTemplateRHSPattern {

  public CLIPSTemplateRHSPatternImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitTemplateRHSPattern(this);
  }
  ...
  @Override
  @NotNull
  public List<CLIPSRHSSlot> getRHSSlotList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CLIPSRHSSlot.class);
  }
