...
public class CLIPSPortSpecificationImpl extends ASTWrapperPsiElement implements CLIPSPortSpecification {

  public CLIPSPortSpecificationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitPortSpecification(this);
  }
  ...
  @Override
  @NotNull
  public CLIPSPortItem getPortItem() {
    return findNotNullChildByClass(CLIPSPortItem.class);
  }
