...
public class CLIPSStorageFacetImpl extends ASTWrapperPsiElement implements CLIPSStorageFacet {

  public CLIPSStorageFacetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitStorageFacet(this);
  }
