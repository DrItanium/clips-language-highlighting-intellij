...
public class CLIPSInstanceNameExpressionImpl extends ASTWrapperPsiElement implements CLIPSInstanceNameExpression {

  public CLIPSInstanceNameExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitInstanceNameExpression(this);
  }
