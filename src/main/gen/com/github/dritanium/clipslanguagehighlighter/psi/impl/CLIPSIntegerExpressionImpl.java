...
public class CLIPSIntegerExpressionImpl extends ASTWrapperPsiElement implements CLIPSIntegerExpression {

  public CLIPSIntegerExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
