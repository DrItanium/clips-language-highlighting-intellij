...
public class CLIPSTypeSpecificationImpl extends ASTWrapperPsiElement implements CLIPSTypeSpecification {

  public CLIPSTypeSpecificationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<CLIPSAllowedType> getAllowedTypeList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CLIPSAllowedType.class);
  }
