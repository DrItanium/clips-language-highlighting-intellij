...
public class CLIPSLexemeListImpl extends ASTWrapperPsiElement implements CLIPSLexemeList {

  public CLIPSLexemeListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitLexemeList(this);
  }
  ...
  @Override
  @NotNull
  public List<CLIPSLexeme> getLexemeList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CLIPSLexeme.class);
  }
