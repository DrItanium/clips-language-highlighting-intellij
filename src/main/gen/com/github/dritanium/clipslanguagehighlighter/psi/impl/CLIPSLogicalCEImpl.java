...
public class CLIPSLogicalCEImpl extends ASTWrapperPsiElement implements CLIPSLogicalCE {

  public CLIPSLogicalCEImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitLogicalCE(this);
  }
