...
public class CLIPSDefaultFacetImpl extends ASTWrapperPsiElement implements CLIPSDefaultFacet {

  public CLIPSDefaultFacetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitDefaultFacet(this);
  }
