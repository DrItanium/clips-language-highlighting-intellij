...
public class CLIPSDeftemplateNameImpl extends ASTWrapperPsiElement implements CLIPSDeftemplateName {

  public CLIPSDeftemplateNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitDeftemplateName(this);
  }
