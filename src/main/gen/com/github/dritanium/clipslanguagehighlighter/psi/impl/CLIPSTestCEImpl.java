...
public class CLIPSTestCEImpl extends ASTWrapperPsiElement implements CLIPSTestCE {

  public CLIPSTestCEImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitTestCE(this);
  }
  ...
  public CLIPSFunctionCall getFunctionCall() {
    return findNotNullChildByClass(CLIPSFunctionCall.class);
  }
