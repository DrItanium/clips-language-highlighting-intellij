...
public class CLIPSSourceFacetImpl extends ASTWrapperPsiElement implements CLIPSSourceFacet {

  public CLIPSSourceFacetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitSourceFacet(this);
  }
