...
public class CLIPSHandlerDocumentationImpl extends ASTWrapperPsiElement implements CLIPSHandlerDocumentation {

  public CLIPSHandlerDocumentationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitHandlerDocumentation(this);
  }
