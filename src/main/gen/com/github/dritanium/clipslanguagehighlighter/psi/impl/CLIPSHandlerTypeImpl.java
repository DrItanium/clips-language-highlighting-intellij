...
public class CLIPSHandlerTypeImpl extends ASTWrapperPsiElement implements CLIPSHandlerType {

  public CLIPSHandlerTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitHandlerType(this);
  }
