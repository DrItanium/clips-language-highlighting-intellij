...
public class CLIPSSingleFieldVariableImpl extends ASTWrapperPsiElement implements CLIPSSingleFieldVariable {

  public CLIPSSingleFieldVariableImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitSingleFieldVariable(this);
  }
  ...
  @Override
  @NotNull
  public CLIPSVariableSymbol getVariableSymbol() {
    return findNotNullChildByClass(CLIPSVariableSymbol.class);
  }
