...
public class CLIPSClassNameListImpl extends ASTWrapperPsiElement implements CLIPSClassNameList {

  public CLIPSClassNameListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitClassNameList(this);
  }
  ...
  @Override
  @NotNull
  public List<CLIPSClassName> getClassNameList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CLIPSClassName.class);
  }
