...
public class CLIPSOrderedRHSPatternImpl extends ASTWrapperPsiElement implements CLIPSOrderedRHSPattern {

  public CLIPSOrderedRHSPatternImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitOrderedRHSPattern(this);
  }
  ...
  @Override
  @NotNull
  public List<CLIPSRHSField> getRHSFieldList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CLIPSRHSField.class);
  }
