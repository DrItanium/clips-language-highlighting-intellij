...
public class CLIPSDefmoduleConstructImpl extends ASTWrapperPsiElement implements CLIPSDefmoduleConstruct {
  ...
  public CLIPSModuleName getModuleName() {
    return findNotNullChildByClass(CLIPSModuleName.class);
  }

  @Override
  @NotNull
  public List<CLIPSPortSpecification> getPortSpecificationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CLIPSPortSpecification.class);
  }
