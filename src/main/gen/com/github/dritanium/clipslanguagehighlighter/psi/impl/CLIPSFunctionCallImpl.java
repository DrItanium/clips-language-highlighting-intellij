...
public class CLIPSFunctionCallImpl extends ASTWrapperPsiElement implements CLIPSFunctionCall {
  ...
  @Override
  @NotNull
  public CLIPSFunctionName getFunctionName() {
    return findNotNullChildByClass(CLIPSFunctionName.class);
  }
