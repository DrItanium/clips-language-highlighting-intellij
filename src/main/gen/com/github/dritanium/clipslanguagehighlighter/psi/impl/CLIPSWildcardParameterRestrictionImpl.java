...
public class CLIPSWildcardParameterRestrictionImpl extends ASTWrapperPsiElement implements CLIPSWildcardParameterRestriction {

  public CLIPSWildcardParameterRestrictionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitWildcardParameterRestriction(this);
  }
  ...
  public CLIPSMultifieldVariable getMultifieldVariable() {
    return findNotNullChildByClass(CLIPSMultifieldVariable.class);
  }
