...
public class CLIPSRHSFieldImpl extends ASTWrapperPsiElement implements CLIPSRHSField {

  public CLIPSRHSFieldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitRHSField(this);
  }
  ...
  @Override
  @Nullable
  public CLIPSVariable getVariable() {
    return findChildByClass(CLIPSVariable.class);
  }
