...
public class CLIPSNotCEImpl extends ASTWrapperPsiElement implements CLIPSNotCE {

  public CLIPSNotCEImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitNotCE(this);
  }
  ...
  @Override
  @NotNull
  public CLIPSConditionalElement getConditionalElement() {
    return findNotNullChildByClass(CLIPSConditionalElement.class);
  }
