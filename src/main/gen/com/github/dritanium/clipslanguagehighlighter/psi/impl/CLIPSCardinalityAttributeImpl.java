...
public class CLIPSCardinalityAttributeImpl extends ASTWrapperPsiElement implements CLIPSCardinalityAttribute {

  public CLIPSCardinalityAttributeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitCardinalityAttribute(this);
  }
