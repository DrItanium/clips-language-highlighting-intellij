...
public class CLIPSSingleSlotDefinitionImpl extends ASTWrapperPsiElement implements CLIPSSingleSlotDefinition {

  public CLIPSSingleSlotDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitSingleSlotDefinition(this);
  }
  ...
  @Override
  @NotNull
  public List<CLIPSTemplateAttribute> getTemplateAttributeList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CLIPSTemplateAttribute.class);
  }
