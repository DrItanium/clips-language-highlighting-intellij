...
public class CLIPSDefmoduleNameImpl extends ASTWrapperPsiElement implements CLIPSDefmoduleName {

  public CLIPSDefmoduleNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitDefmoduleName(this);
  }
