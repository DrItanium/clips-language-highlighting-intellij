...
public class CLIPSAccessFacetImpl extends ASTWrapperPsiElement implements CLIPSAccessFacet {

  public CLIPSAccessFacetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitAccessFacet(this);
  }
