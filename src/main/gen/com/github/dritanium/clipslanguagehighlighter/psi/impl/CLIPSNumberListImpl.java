...
public class CLIPSNumberListImpl extends ASTWrapperPsiElement implements CLIPSNumberList {

  public CLIPSNumberListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitNumberList(this);
  }
  ...
  @Override
  @NotNull
  public List<CLIPSNumber> getNumberList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CLIPSNumber.class);
  }
