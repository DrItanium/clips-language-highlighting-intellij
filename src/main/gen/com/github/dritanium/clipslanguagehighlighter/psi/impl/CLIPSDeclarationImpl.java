...
public class CLIPSDeclarationImpl extends ASTWrapperPsiElement implements CLIPSDeclaration {

  public CLIPSDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<CLIPSRuleProperty> getRulePropertyList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CLIPSRuleProperty.class);
  }
