...
public class CLIPSSlotNameExpressionImpl extends ASTWrapperPsiElement implements CLIPSSlotNameExpression {

  public CLIPSSlotNameExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitSlotNameExpression(this);
  }
