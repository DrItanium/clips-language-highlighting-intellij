...
public class CLIPSSingleConstraintImpl extends ASTWrapperPsiElement implements CLIPSSingleConstraint {

  public CLIPSSingleConstraintImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitSingleConstraint(this);
  }
  ...
  @Override
  @NotNull
  public CLIPSTerm getTerm() {
    return findNotNullChildByClass(CLIPSTerm.class);
  }
