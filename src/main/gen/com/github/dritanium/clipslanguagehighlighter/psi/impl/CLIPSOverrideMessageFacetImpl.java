...
public class CLIPSOverrideMessageFacetImpl extends ASTWrapperPsiElement implements CLIPSOverrideMessageFacet {

  public CLIPSOverrideMessageFacetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitOverrideMessageFacet(this);
  }
  ...
  public CLIPSMessageName getMessageName() {
    return findChildByClass(CLIPSMessageName.class);
  }
