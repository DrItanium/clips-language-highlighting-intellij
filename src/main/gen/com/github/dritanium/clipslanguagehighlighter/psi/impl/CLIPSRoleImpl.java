...
public class CLIPSRoleImpl extends ASTWrapperPsiElement implements CLIPSRole {

  public CLIPSRoleImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public CLIPSRole getRole() {
    return findNotNullChildByClass(CLIPSRole.class);
  }
