...
public class CLIPSMultislotDefinitionImpl extends ASTWrapperPsiElement implements CLIPSMultislotDefinition {

  public CLIPSMultislotDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitMultislotDefinition(this);
  }
