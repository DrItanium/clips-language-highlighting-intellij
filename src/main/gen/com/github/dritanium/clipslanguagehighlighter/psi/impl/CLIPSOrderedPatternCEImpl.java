...
public class CLIPSOrderedPatternCEImpl extends ASTWrapperPsiElement implements CLIPSOrderedPatternCE {

  public CLIPSOrderedPatternCEImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitOrderedPatternCE(this);
  }
