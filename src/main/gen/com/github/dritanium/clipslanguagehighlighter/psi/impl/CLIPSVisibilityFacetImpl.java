...
public class CLIPSVisibilityFacetImpl extends ASTWrapperPsiElement implements CLIPSVisibilityFacet {

  public CLIPSVisibilityFacetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitVisibilityFacet(this);
  }
